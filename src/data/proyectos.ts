...
export const proyectos: Proyecto[] = [
  {
    ...
    descripcion:
      "Proyecto de animación 3D centrado en iluminación, ritmo y storytelling del producto. Incluye tablero, tren y elementos tipo personaje.",
    etiquetas: ["Maya", "Iluminación", "Animación"],
    portada: "/img/proyectos/detour/portada.jpg",
    galeria: [
      "/img/proyectos/detour/1.jpg",
      "/img/proyectos/detour/2.jpg",
  ...
  },
  {
    ...
    portada: "/img/proyectos/bornfromsyn/MudJeans_1 (1).jpg",
    galeria: [
      "/img/proyectos/bornfromsyn/MudJeans_1 (1).jpg",
      "/img/proyectos/bornfromsyn/MudJeans_2 (1).jpg",
      "/img/proyectos/bornfromsyn/MudJeans_3 (1).jpg",
      "/img/proyectos/bornfromsyn/Front.png",
      "/img/proyectos/bornfromsyn/Front Open.png",
      "/img/proyectos/bornfromsyn/Back.png",
    ],
